#!/bin/bash
# Deploy BracketDiffusion to a remote GPU instance from your local machine.
#
# Usage:
...
# The service keeps running in tmux session "bracketdiffusion" on the remote.
# Reattach with: ssh <host> -t tmux attach -t bracketdiffusion

set -euo pipefail

SERVICE_NAME="bracketdiffusion-service"
REPO_URL="https://github.com/alxBO/bracketdiffusion-service.git"
TMUX_SESSION="bracketdiffusion"
REMOTE_WORKDIR="~"
