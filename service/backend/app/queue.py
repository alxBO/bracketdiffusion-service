...
MAX_QUEUE_SIZE = 50
QUEUE_TIMEOUT_SECONDS = 3600  # 60 min max wait (diffusion is slow)
    ...
    def _run_inference(self, job_id: str, req: GenerateRequest, job):
        ...
        try:
            ...
            hdr_out = pipeline.run(
                ...
                num_brackets=req.num_brackets,
                ev_steps=req.ev_steps,
                diffusion_steps=req.diffusion_steps,
                lambda_0=req.lambda_0,
                lambda_s=req.lambda_s,
                lambda_d=req.lambda_d,
                noise_sigma=req.noise_sigma,
                crf_type=req.crf_type,
                seed=req.seed,
            )
